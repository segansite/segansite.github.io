...
Elm.Page.make = function (_elm) {
   ...
   var lineText = F2(function (_p1,s) {
      ...
      $Graphics$Collage.text($Text.bold(A2($Text.color,$Color.black,$Text.fromString(s)))));
   });
   ...
   var pointsToSquare = F3(function (_p5,c,lps) {
      ...
      if (_p7.ctor === "[]") {
            ...
            A2($Graphics$Collage.filled,c,$Graphics$Collage.circle(1))),
   ...
   var background = F2(function (_p16,st) {
      ...
      var _p18 = _p17._1;
      return A2($Basics._op["++"],
      _U.list([$Graphics$Collage.toForm(A3($Graphics$Element.image,_p19,_p18,"img/personalBackground.png"))
              ,A2($Graphics$Collage.moveY,280,$Graphics$Collage.toForm(A3($Graphics$Element.image,500,130,"img/personalLogo.png")))
              ,A2($Graphics$Collage.move,
      ...
      _U.list([A2($Graphics$Collage.moveY,50,$Graphics$Collage.toForm(A3($Graphics$Element.image,200,50,"img/about.png")))
              ,A2($Graphics$Collage.moveY,-110,$Graphics$Collage.toForm(A3($Graphics$Element.image,700,120,"img/textBack.png")))
              ,A2($Graphics$Collage.move,
              ...
              $Graphics$Collage.toForm(A3($Graphics$Element.image,385,110,"img/textBox.png")))
              ,A2(lineText,
